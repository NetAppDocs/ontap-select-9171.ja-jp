...
summary: Pythonコードサンプルを使用してONTAP Selectクラスタを作成または削除する場合は、スクリプトへの入力としてJSONファイルを提供する必要があります。導入計画に応じて、適切なJSONサンプルをコピーして修正することができます。 
---
...
[role="lead"]
Pythonコードサンプルを使用してONTAP Selectクラスタを作成または削除する場合は、スクリプトへの入力としてJSONファイルを提供する必要があります。導入計画に応じて、適切なJSONサンプルをコピーして修正することができます。
...
== vCenter を使用した ESXi 上の単一ノード クラスタ
