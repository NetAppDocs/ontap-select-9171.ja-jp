...
** Rocky Linux 10.0、9.7、9.6、9.5、9.4、9.3、9.2、9.1、9.0、8.9、8.8、8.7、8.6
...
link:kvm-host-configuration-and-preparation-checklist.html["ホスト準備チェックリスト"]に従い、link:reference_chk_deploy_req_info.html["デプロイユーティリティのインストール"]およびlink:reference_chk_select_req_info.html["ONTAP Selectのインストール"]に必要な情報を確認してください。
